...
export default function Profile() {
  ...
  const handleDeleteListing =async (listingId)=>{
    try {
      ...
      setShowLists((prev)=>prev.filter((listing)=>listing._id!==listingId));
    ...
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        >
         ...
         <Link className='bg-orange-900 text-white hover:opacity-95 p-3 rounded-lg uppercase text-center' to={"/create-listing"}>
        Create Listing
        </Link> 
      </form>
      ...
      <button onClick={handleShowLists} className='text-lime-700 w-full'>Show my lists</button>
      <p className='text-red-700 mt-5'>{showListsError? 'Error showing Lists...':''}</p>
